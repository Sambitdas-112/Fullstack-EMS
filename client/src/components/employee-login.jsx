          ...
          <div className="card-body p-4">
            ...
            <div className="text-center mb-4">
              <div
                ...
                <span className="bi bi-person-badge-fill text-white fs-5"></span>
              </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="mb-4">
                ...
                <div className="input-group">
                  ...
                  <input type="password" className={`form-control ${ errors.password ? "is-invalid" : "" }`} placeholder="Enter your password" {...register("password", {required: "Password is required", minLength: {value: 6, message: "Minimum 6 characters",},})}/>
                </div>
              ...
              <button type="submit" disabled={loading} className="btn w-100 text-white fw-semibold" style={{background: "linear-gradient(135deg,#198754,#20c997)", border: "none", height: "42px",}}>
                {loading ? (
                  <>
              ...
              <Link to="/login" className="btn btn-light border w-100 mt-3">Back to Portals</Link>
            </form>
